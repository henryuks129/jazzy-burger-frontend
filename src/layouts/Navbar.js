        ...
        <div className='container nav-body sticky-top'>
            <div className='d-flex justify-content-between align-items-center'>
                <div className='d-inline-flex gap-3 align-items-center'>
                    ...
                    <div className='location-nav d-flex gap-2 '>
                    <img className='nav-location mt-1 d-none d-lg-block' src={location} alt="" />
                    <p className='nav-logo-text mt-3 d-none d-lg-block'>Lagos, Nigeria</p>
                    </div>
                </div>
                <div className='d-flex gap-4'>
                  ...
                  <div className='d-inline-flex gap-2 nav-person-section'>
                    ...
                    <div className='d-inline-flex gap-2 guest-div'>
                    <p className='nav-person-text pt-1 d-none d-lg-block'>Hi, Guests</p>
                    <img className='nav-dropdown pt-1 d-none d-lg-block' src={dropdown} alt="" />
                    </div>
                    {/* </div> */}
                  </div>
                  <div>
